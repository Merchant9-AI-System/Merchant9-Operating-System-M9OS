...
// Inline literal (bukan `CalendarRootProps & {...}` drpd reka-ui) - rujuk Command.vue utk
// sebab. Matcher/WeekDayFormat/WeekStartsOn/Direction turut disalin terus (bentuk ringkas,
// bukan diimport sbg TYPE drpd reka-ui - rujuk node_modules/reka-ui/dist/index2.d.ts &
// index4.d.ts utk sumber asal).
