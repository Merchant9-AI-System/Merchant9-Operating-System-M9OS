 ...
 * ProductImageFetcher/MerchantWebsiteSearch ORIGIN), bukan dimuat turun tempatan. script-src/
 * style-src kekal 'unsafe-inline' (bukan nonce ketat) - Livewire/Alpine/Filament suntik skrip/
 * gaya inline utk hydration komponen; nonce penuh perlukan kerja lebih menyeluruh merentasi
 * Livewire/Inertia & risiko pecahkan panel admin production semasa waktu bekerja staf.
 *
...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $response->headers->set('Content-Security-Policy', implode('; ', [
            ...
            "img-src 'self' data: https://merchant9.com",
            "font-src 'self' data:",
            "connect-src 'self'",
            "object-src 'none'",
            "base-uri 'self'",
